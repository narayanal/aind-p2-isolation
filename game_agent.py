...
def board_position(pos):
    if( pos[0] == 3 or 4 ): score_0 = 3
    if( pos[0] == 5 or 2 ): score_0 = 2
    if( pos[0] == 6 or 1 ): score_0 = 1
    if( pos[0] == 7 or 0 ): score_0 = 0

    if (pos[1] == 3 or 4): score_1 = 3
    if (pos[1] == 5 or 2): score_1 = 2
    if (pos[1] == 6 or 1): score_1 = 1
    if (pos[1] == 7 or 0): score_1 = 0
...
def custom_score(game, player):
    ...
    own_pos_score = board_position(own_pos)
    opp_moves = len(game.get_legal_moves(game.get_opponent(player)))
    opp_pos = game.get_player_location(game.get_opponent(player))
    opp_pos_score = board_position(opp_pos)
    #open_spaces = len(game.get_blank_spaces())
    w = [1,2,1,2]
    return float( ( w[0] * own_moves * own_moves - w[1] * opp_moves * opp_moves )/8 + 0.5 * ( w[2] * own_pos_score - w[3] * opp_pos_score)/6 )
...
def custom_score_2(game, player):
    ...
    open_spaces = len(game.get_blank_spaces())
    w = [1, 2, 3]
    return float((w[0] * own_moves - w[1] * opp_moves) / 8 )
...
def custom_score_3(game, player):
    ...
    #open_spaces = len(game.get_blank_spaces())
    w = [1, 2, 1, 1]
    return float((w[0] * own_moves *own_moves - w[1] * opp_moves * opp_moves) / 8 )
...
class IsolationPlayer:
    ...
    ********************  DO NOT MODIFY THIS CLASS  ********************
    ...
    timeout : float (optional)
        ...
        timer expires.
    """
    def __init__(self, search_depth=6, score_fn=custom_score, timeout=20.):
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        bestMove = game_moves[random.randint(0, len(game_moves) - 1)]
